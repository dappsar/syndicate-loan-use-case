...
function printNetwork () {
    web3.eth.net.getId().then( (netId) => {
        switch (netId) {
            ...
            ($('#bc_network').html("Ethereum Mainnet <span class=\"warning\"> - Please switch to Kovan - </span>"));
            break
            case 2:
            // console.log('This is the deprecated Morden test network.');
            ($('#bc_network').html("Morden <span class=\"warning\"> - Please switch to Kovan - </span>"));
            break
            case 3:
            // console.log('This is the Ropsten test network.');
            ($('#bc_network').html("Ropsten <span class=\"warning\"> - Please switch to Kovan - </span>"));
            break
            case 4:
            // console.log('This is the Rinkeby test network.');
            ($('#bc_network').html("Rinkeby <span class=\"warning\"> - Please switch to Kovan - </span>"));
            break
            case 5:
            ...
            ($('#bc_network').html("Unkown <span class=\"warning\"> - Please switch to Kovan - </span>"));
            }
        })
}
